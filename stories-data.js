// stories-data.js - 30 قصة تعليمية قصيرة (10 لكل مستوى)
const STORIES_DATA = {
    // ==================== المستوى المبتدئ ====================
    beginner: [
        {
...
// التحقق من التحميل
console.log('✅ stories-data.js loaded with', 
    STORIES_DATA.beginner.length + STORIES_DATA.intermediate.length + STORIES_DATA.advanced.length, 'قصص');
